...
\tableofcontents
\chapter{導入}
この講義のタイトルは「相対論的量子力学」です。文字通り量子力学を相対論的にしようという試みです。まずそれぞれについて、どんなものだったか復習しましょう。

ここで相対論とは、ここでは特殊相対論のことです。特殊相対論とはLorentz変換によって物理法則が不変になるという、理論の枠組みのことでした。
...
量子力学以降の現代的な物理では、「物理量」と「理論の記述」を区別することが重要です。}。

もう一方の量子力学は、Schr\"{o}dinger方程式で記述されるような、波動関数を考えるものでした。１粒子の場合だと波動関数を$\psi(t,\xb)$として、
\begin{align}
...
この後、講義で説明するように量子力学を相対論的に書き換えようと、困難に直面します。
...
正しく相対論的に量子力学を記述できる理論は、次の２つの条件を満たさなければなりません。
\begin{itemize}
...
\end{important}
をやればよいことになります。実はこれは深い意味があり、ゲージ対称性から説明することができます。それは、この講義の後の方で出てきます。
